...
public class MfiMbsTxnLnrepayVO extends MaintenanceVO<MfiMbsTxnLnrepayV> {
	
	/*SOP are Commented ==> Changes for Asomi Nirmal kanna S*/
	
	public MfiMbsTxnLnrepayVO() {
		entity = new MfiMbsTxnLnrepayV();
	}
	
	public MfiMbsTxnLnrepayVO(MfiMbsTxnLnrepayV entity) {
		super(entity);
	}
	...
	public Double getRepaymentAmountDue() {
		return entity.getRepaymentAmountDue();
	}

	public void setRepaymentAmountDue(Double repaymentAmountDue) {
		entity.setRepaymentAmountDue(repaymentAmountDue);

	}

	public Double getSettledAmount() {
		return entity.getSettledAmount();
	}

	public void setSettledAmount(Double SettledAmount) {
		entity.setSettledAmount(SettledAmount);
	...
	public Date getTxnInitTime() {
		//System.out.println("getTxnInitTime "+entity.getTxnInitTime());
	...
	public Date getTxnSyncTime() {
		//System.out.println("getTxnInitTime "+entity.getTxnSyncTime());

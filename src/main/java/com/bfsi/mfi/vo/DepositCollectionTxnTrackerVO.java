...
public class DepositCollectionTxnTrackerVO extends MaintenanceVO<DepositCollectionTxnTracker>{
	public DepositCollectionTxnTrackerVO()
	{
		entity=new DepositCollectionTxnTracker();
	}
	
	public DepositCollectionTxnTrackerVO(DepositCollectionTxnTracker entity) {
		super(entity);
	}

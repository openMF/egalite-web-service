...
public class ModifyManualAgendaSettleVO extends MaintenanceVO<ModifyManualAgendaSettle>{   
	public ModifyManualAgendaSettleVO() {
		entity = new ModifyManualAgendaSettle();
	}

	public ModifyManualAgendaSettleVO(ModifyManualAgendaSettle entity) {
		super(entity);
	}	
	...
	public Object clone() {
		ModifyManualAgendaSettleVO copyObj = new ModifyManualAgendaSettleVO();

...
@Repository
public class AgendaLoanJdbcDao extends MaintenanceJdbcDao<AgendaView> implements AgendaLoanDao {	
	...
	protected String getSelectByPkQuery() {
		return ApplicationQuery.QUERY_LOAN_AGENDA_ID_DATA;
	}

	@Override
	protected String getSelectAllQuery() {
		// TODO Auto-generated method stub
		return ApplicationQuery.QUERY_LOAN_AGENDA_SELECTDATA;
	}

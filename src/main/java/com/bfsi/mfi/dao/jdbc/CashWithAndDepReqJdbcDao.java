...
@Repository("cashWithAndDepreqDao")
public class CashWithAndDepReqJdbcDao extends MaintenanceJdbcDao<MbsReqReceiverView> implements CashWithAndDepreqDao{
	...
	protected String getSelectAllQuery() {
		return ApplicationQuery.WITHDEPREQ_SELECT_QUEARY_ALL;
	}
	...
	protected String getSelectByPkQuery() {
		return ApplicationQuery.WITHDEPREQ_SELECT_QUEARY_ALL_PK;
	}

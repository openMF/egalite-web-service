...
@Repository("txnTrackerDao")
public class TxnTrackerJdbcDao extends ReadOnlyMaintenanceJdbcDao<MfiMbsTxnReceiverV> implements TxnTrackerDao 
{
	@Override
	protected String getSelectAllQuery() {
		return ApplicationQuery.TXN_QUERY_SELECT_ALL;
	}
...
/*	private static final class AgentMapper implements RowMapper<AgentTransaction> 
	...
	private static final class AgentMapper implements RowMapper<MfiMbsTxnReceiverV> 
	{
		public MfiMbsTxnReceiverV mapRow(ResultSet rs, int rowNum) throws SQLException 
		{
			...
			/*mfiMbsTxnReceiver.setLoanAcNo(rs.getString("LOAN_AC_NO"));
			mfiMbsTxnReceiver.setParentLoanAcNo(rs.getString("PARENT_LOAN_AC_NO"));
			mfiMbsTxnReceiver.setParentCustId(rs.getString("PARENT_CUST_ID"));
			mfiMbsTxnReceiver.setIsGroupLoan(rs.getString("IS_GROUP_LOAN"));
			mfiMbsTxnReceiver.setIsParentLoan(rs.getString("IS_PARENT_LOAN"));*/

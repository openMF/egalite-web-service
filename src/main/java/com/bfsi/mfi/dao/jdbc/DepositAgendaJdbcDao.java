...
@Repository
public class DepositAgendaJdbcDao extends MaintenanceJdbcDao<Agenda> implements DepositAgendaDao {	
	...
	protected String getSelectByPkQuery() {
		return ApplicationQuery.QUERY_DEPOSIT_AGENDA_ID;
	}
			
	@Override
	protected String getSelectAllQuery() {
		// TODO Auto-generated method stub
		return ApplicationQuery.QUERY_DEPOSIT_AGENDA_SELECT;
	}

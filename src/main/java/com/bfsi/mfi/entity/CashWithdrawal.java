...
@Entity(name = "mfi_mbs_req_cashwdrl_v")
@XmlRootElement
@XmlAccessorType(XmlAccessType.FIELD)
public class CashWithdrawal extends MaintenanceEntity {
	public CashWithdrawal() {
	}
	
	/*a.mbs_txn_id,//super id
	a.txn_code,a.cbs_ac_ref_no,a.branch_code,a.customer_id,b.customer_full_name,
	a.agent_id, agent_name,a.location_code,l.location_desc, txn_amount,

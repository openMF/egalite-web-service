...
@Entity(name = "MFI_MBS_TXN_LNREPAY_V")
@XmlRootElement
@XmlAccessorType(XmlAccessType.FIELD)
public class MfiMbsTxnLnrepayV  extends MaintenanceEntity {
	
	/*SOP are Commented ==> Changes for Asomi Nirmal kanna S*/
	public MfiMbsTxnLnrepayV() {
	...
	@Column(name = "REPAYMENT_AMOUNT_DUE", nullable = true)
	private Double repaymentAmountDue;
...
*/
	...
	public Double getRepaymentAmountDue() {
		return repaymentAmountDue;
	}

	public void setRepaymentAmountDue(Double repaymentAmountDue) {
		this.repaymentAmountDue = repaymentAmountDue;
	}
	...
	public Date getTxnInitTime() {
		//System.out.println("txnInitTime="+txnInitTime);
		return txnInitTime;
	}
	...
	public Date getTxnSyncTime() {
		//System.out.println("txnSyncTime="+txnSyncTime);
		return txnSyncTime;
	}

...
@Entity(name = "mfi_mbs_req_dpprepay_v")
@XmlRootElement
@XmlAccessorType(XmlAccessType.FIELD)
public class MbsReqDpPrepayView extends MaintenanceEntity{
	public MbsReqDpPrepayView() {
	}
	/*a.mbs_txn_id,//super id
	 * a.txn_code,a.cbs_ac_ref_no,a.branch_code,a.customer_id,
	b.customer_full_name,a.agent_id,
	(c.first_name ||' '||c.last_name) as agent_name,
	a.location_code,l.location_desc,a.txn_settled_amt as amount_paid,

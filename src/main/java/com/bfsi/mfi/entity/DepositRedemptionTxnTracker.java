...
@Entity(name = "MFI_MBS_TXN_DPREDEMPTION_V")
@XmlRootElement
@XmlAccessorType(XmlAccessType.FIELD)
public class DepositRedemptionTxnTracker extends MaintenanceEntity{
	...
	@Column(name = "AMOUNT_PAID_OUT", nullable = true)
	private Double amountPaidOut;
	...
	@Column(name = "REDEMPTION_AMOUNT", nullable = true)

...
public class CbsEnrollCustomer extends CbsBaseRequest{
	...
	private CbsEnrollCustomerDocument document;
	...
	public CbsEnrollCustomerDocument getDocument() {
		return document;
	}
	public void setDocument(CbsEnrollCustomerDocument document) {

...
public class CbsLoanDetails {
	...
	private String cbsLoanShortCode;
	...
	public String getCbsLoanShortCode() {
		return cbsLoanShortCode;
	}
	public void setCbsLoanShortCode(String cbsLoanShortCode) {
		this.cbsLoanShortCode = cbsLoanShortCode;
	}

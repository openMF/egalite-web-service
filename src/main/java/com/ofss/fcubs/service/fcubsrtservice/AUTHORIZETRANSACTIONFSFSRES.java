 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="Transaction-Details" type="{http://fcubs.ofss.com/service/FCUBSRTService}Retail-Teller-Type-Full"/>
...
@XmlRootElement(name = "AUTHORIZETRANSACTION_FSFS_RES")
public class AUTHORIZETRANSACTIONFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AUTHORIZETRANSACTIONFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AUTHORIZETRANSACTIONFSFSRES.FCUBSBODY }
     *     
     */
    public AUTHORIZETRANSACTIONFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AUTHORIZETRANSACTIONFSFSRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Transaction-Details", required = true)
        protected RetailTellerTypeFull transactionDetails;
         ...
         * @return
         *     possible object is
         *     {@link RetailTellerTypeFull }
         *     
         */
        public RetailTellerTypeFull getTransactionDetails() {
         ...
         *     
         */
        public void setTransactionDetails(RetailTellerTypeFull value) {

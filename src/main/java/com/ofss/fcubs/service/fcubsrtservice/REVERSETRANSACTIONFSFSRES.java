...
@XmlRootElement(name = "REVERSETRANSACTION_FSFS_RES")
public class REVERSETRANSACTIONFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected REVERSETRANSACTIONFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link REVERSETRANSACTIONFSFSRES.FCUBSBODY }
     *     
     */
    public REVERSETRANSACTIONFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(REVERSETRANSACTIONFSFSRES.FCUBSBODY value) {

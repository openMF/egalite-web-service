...
@XmlRootElement(name = "AUTHORIZETRANSACTION_IOPK_RES")
public class AUTHORIZETRANSACTIONIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected AUTHORIZETRANSACTIONIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link AUTHORIZETRANSACTIONIOPKRES.FCUBSBODY }
     *     
     */
    public AUTHORIZETRANSACTIONIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(AUTHORIZETRANSACTIONIOPKRES.FCUBSBODY value) {

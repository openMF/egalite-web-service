...
@XmlRootElement(name = "CREATETRANSACTION_IOPK_RES")
public class CREATETRANSACTIONIOPKRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CREATETRANSACTIONIOPKRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CREATETRANSACTIONIOPKRES.FCUBSBODY }
     *     
     */
    public CREATETRANSACTIONIOPKRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CREATETRANSACTIONIOPKRES.FCUBSBODY value) {

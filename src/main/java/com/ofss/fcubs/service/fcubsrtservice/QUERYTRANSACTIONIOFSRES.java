...
@XmlRootElement(name = "QUERYTRANSACTION_IOFS_RES")
public class QUERYTRANSACTIONIOFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected QUERYTRANSACTIONIOFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link QUERYTRANSACTIONIOFSRES.FCUBSBODY }
     *     
     */
    public QUERYTRANSACTIONIOFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(QUERYTRANSACTIONIOFSRES.FCUBSBODY value) {

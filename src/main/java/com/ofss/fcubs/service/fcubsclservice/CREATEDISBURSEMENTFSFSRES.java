 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="Dsbr-Master-Full" type="{http://fcubs.ofss.com/service/FCUBSCLService}Disbursement-Full-Type"/>
...
@XmlRootElement(name = "CREATEDISBURSEMENT_FSFS_RES")
public class CREATEDISBURSEMENTFSFSRES {

    @XmlElement(name = "FCUBS_HEADER", required = true)
    protected FCUBSHEADERType fcubsheader;
    @XmlElement(name = "FCUBS_BODY", required = true)
    protected CREATEDISBURSEMENTFSFSRES.FCUBSBODY fcubsbody;
     ...
     * @return
     *     possible object is
     *     {@link CREATEDISBURSEMENTFSFSRES.FCUBSBODY }
     *     
     */
    public CREATEDISBURSEMENTFSFSRES.FCUBSBODY getFCUBSBODY() {
        return fcubsbody;
    }
     ...
     *     
     */
    public void setFCUBSBODY(CREATEDISBURSEMENTFSFSRES.FCUBSBODY value) {
    ...
    public static class FCUBSBODY {
        ...
        @XmlElement(name = "Dsbr-Master-Full", required = true)
        protected DisbursementFullType dsbrMasterFull;
        ...
        /**
         * Gets the value of the dsbrMasterFull property.
         * 
         * @return
         *     possible object is
         *     {@link DisbursementFullType }
         *     
         */
        public DisbursementFullType getDsbrMasterFull() {
            return dsbrMasterFull;
        }

        /**
         * Sets the value of the dsbrMasterFull property.
         * 
         * @param value
         *     allowed object is
         *     {@link DisbursementFullType }
         *     
         */
        public void setDsbrMasterFull(DisbursementFullType value) {
            this.dsbrMasterFull = value;
        }
